...
class FormAndPreview extends Component {
  ...
  callMintMyNFTFromApp = (e) => {
    ...
    this.props.mintMyNFT(
      ...
      this.state.junkGuyName,
      this.state.junkGuyPrice
    );
  };
      ...
      <div>
        <div className="card mt-1">
          <div className="card-body align-items-center d-flex justify-content-center">
            <h5>Color Your Junk Guy As You Want It To be!</h5>
          </div>
        </div>
        <form onSubmit={this.callMintMyNFTFromApp} className="pt-4 mt-1">
          <div className="row">
            ...
            <div className="col-md-6 d-flex justify-content-center align-items-center">
              <JunkGuyNFTImage colors={this.state.userSelectedColors[0]} />
            </div>
          </div>
          <div className="row">
            <div className="col-md-3">
            ...
            <div className="col-md-6">
              <div className="form-group">
                <label htmlFor="junkGuyName">Name</label>
                <input
                  required
                  type="text"
                  value={this.state.junkGuyName}
                  className="form-control"
                  placeholder="Enter Your Junk Guy's Name"
                  onChange={(e) =>
                    this.setState({ junkGuyName: e.target.value })
                  }
                />
              </div>
              <div>
                ...
                <input
                  ...
                  name="price"
                  id="junkGuyPrice"
                  value={this.state.junkGuyPrice}
                  className="form-control"
                  placeholder="Enter Price In Ξ"
                  onChange={(e) =>
                    this.setState({ junkGuyPrice: e.target.value })
                  }
                />
              </div>
              <button
